...
iOS | Android
------- | ----
<img title="iOS" src="https://github.com/huangzuizui/rn-alipay/blob/master/assets/ios_screen.gif"> | <img title="Android" src="https://raw.githubusercontent.com/huangzuizui/rn-alipay/master/assets/android_screen.gif">
...
5. 在`Build Phases`选项卡的`Link Binary With Libraries`中，增加以下依赖：
<img title="Android" src="https://img.alicdn.com/top/i1/LB1PlBHKpXXXXXoXXXXXXXXXXXX">
...
1. 导入模块
```javascript
const RNAlipay = require('rn-alipay');
```
2. 基本使用
```javascript
  const privateKey = '';
  const data = {
      privateKey,
      partner: '2088302271111110',
      seller: '12312341234',
